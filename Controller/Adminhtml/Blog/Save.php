...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\OneAgrix\CustomBlog\Model\Blog::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('oneagrix_customblog_blog');
            ...
            $this->dataPersistor->set('oneagrix_customblog_blog', $data);
